# ==============================================================================
# Modified Mar 2018 to read digit pairs instead of all digits
...
def read_data_sets(train_dir,
  ...
  ind = numpy.concatenate((ind1, ind2))
  labels_all[ind1] = 0
  labels_all[ind2] = 1
  images = images_all[ind]
  labels = labels_all[ind]

  perm0 = numpy.arange(images.shape[0])
  prng = RandomState(42)
  prng.shuffle(perm0)
  images = images[perm0]
  labels = labels[perm0]

  train_size = numpy.int((1-test_ratio)*(1-validation_ratio)*images.shape[0])
  test_size = numpy.int(test_ratio*images.shape[0])

  train_images = images[:train_size]
  train_labels = labels[:train_size].reshape((-1,1))
  validation_images = images[train_size:-test_size]
  validation_labels = labels[train_size:-test_size].reshape((-1,1))
  test_images = images[-test_size:]
  test_labels = labels[-test_size:].reshape((-1,1))
